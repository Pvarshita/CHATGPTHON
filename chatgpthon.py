...
def get_recipe():
    file=pd.read_csv("C:\\Users\\midam\\Downloads\\Indianfood\\IndianFoodDatasetCSV.csv", encoding='ISO-8859-1')
...
def get_stories():
    file=pd.read_csv("C:\\Users\\midam\\Downloads\\stories_me.csv", encoding='ISO-8859-1')
...
def get_quotes():
    file=pd.read_csv("C:\\Users\\midam\\Downloads\\quotes.csv\\quotes.csv", encoding='ISO-8859-1')
...
def generate_response(user_input):
    ...
    elif any(token.text.lower() in ["motivational","quotes","feeling","unmotivated","sad","lonely","depressed"] for token in doc):
    # retrieve a story
